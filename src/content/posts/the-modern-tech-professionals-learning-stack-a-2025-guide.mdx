...
**Primary (Theory):** Coursera. I start with a well-structured Specialization here, like the [Google Data Analytics Professional Certificate](https://www.coursera.org/professional-certificates/google-data-analytics), to understand the foundational concepts and methodologies.

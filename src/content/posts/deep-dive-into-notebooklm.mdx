...
import gameChanger from '../../../public/images/blog/deep-dive-into-notebooklm/Why-NoteBookLM-is-a-Game-Changer.png';
import gettingBearings from '../../../public/images/blog/deep-dive-into-notebooklm/Getting-My-Bearings-Setting-Up-and-Feeding-NoteBookLM.png';
import sheerTotal from '../../../public/images/blog/deep-dive-into-notebooklm/Getting-My-Bearings-Setting-Up-and-Feeding-NoteBookLM-2.png';
import multiDocumentation from '../../../public/images/blog/deep-dive-into-notebooklm/Getting-My-Bearings-Setting-Up-and-Feeding-NoteBookLM-3.png';
import mindMap from '../../../public/images/blog/deep-dive-into-notebooklm/Getting-My-Bearings-Setting-Up-and-Feeding-NoteBookLM-4.png';
import additionalFeatures from '../../../public/images/blog/deep-dive-into-notebooklm/Getting-My-Bearings-Setting-Up-and-Feeding-NoteBookLM-5.png';
...
<Image 
  src={gameChanger}
  alt="Why NoteBookLM is a Game-Changer"
...
I experienced this firsthand, as I mentioned in [Day 1](https://wanderings.skill-wanderer.com/blog/the-skill-wanderers-compass/), when it helped me make sense of that massive [Orange Pi](https://www.orangepi.org/orangepiwiki/index.php/Main_Page) manual. But it was more than just general sense-making. I was specifically trying to figure out how to install [Ubuntu](https://en.wikipedia.org/wiki/Ubuntu) on its [eMMC (embedded MultiMediaCard)](https://en.wikipedia.org/wiki/MultiMediaCard#eMMC). The seller had told me they only knew how to install it on an [SD card](https://en.wikipedia.org/wiki/SD_card), which was less ideal for performance. I'd even bought an SD card based on that, which is now, amusingly, left for nothing!
...
<Image 
  src={multiDocumentation}
  alt="Multi documentation"
  class="rounded-lg shadow-lg mb-6"
/>

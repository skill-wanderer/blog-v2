...
<div class="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden border-2 shadow-xl mb-8">
  <iframe 
    src="https://www.youtube-nocookie.com/embed/36VCWNOv84w?si=5Fh6WM7NsodFtEvS" 
    frameborder="0" 
...
<iframe data-testid="embed-iframe" style="border-radius:12px" src="https://open.spotify.com/embed/episode/6fcsc3E0lZTXIH3HFm0nWS?utm_source=generator" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

**📑 Slide Version**: Prefer a slide deck? View the presentation below or [download the PDF](https://cdn.jsdelivr.net/gh/skill-wanderer/blog-v2-material@main/wanderers-log-4-goodbye-moodle-hello-custom-lms/The_AI_Build_Revolution.pdf).

<div class="rounded-lg overflow-hidden border-2 shadow-xl mb-8" style="width: 100%; height: 600px;">
  <iframe 
    src="https://cdn.jsdelivr.net/gh/skill-wanderer/blog-v2-material@main/wanderers-log-4-goodbye-moodle-hello-custom-lms/The_AI_Build_Revolution.pdf" 
    style="width: 100%; height: 100%; border: none;"
    title="The AI Build Revolution — Presentation Slides">
  </iframe>
</div>

**🖼️ Infographic**: Get a visual overview of why we're building our own LMS:

<img src="https://cdn.jsdelivr.net/gh/skill-wanderer/blog-v2-material@main/wanderers-log-4-goodbye-moodle-hello-custom-lms/infographic.png" alt="Goodbye Moodle, Hello Custom LMS — Infographic overview of the pain points, audit, and plan" class="w-full h-auto rounded-lg shadow-xl mb-8" />

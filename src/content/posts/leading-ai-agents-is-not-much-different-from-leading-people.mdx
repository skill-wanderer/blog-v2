...
<div class="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden border-2 shadow-xl mb-8">
  <iframe 
    src="https://www.youtube-nocookie.com/embed/m2XS4Fxlfi0?si=K3YHq9befdyAqjCT" 
    frameborder="0" 
...
<div class="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden border-2 shadow-xl mb-8">
  <iframe 
    src="https://www.youtube-nocookie.com/embed/sK3PVWnbflk?si=hhyt6bl0mhn58rPA" 
    frameborder="0" 
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
    referrerpolicy="strict-origin-when-cross-origin" 
    allowfullscreen
    title="Leading AI Is Surprisingly Not That Different From Leading People — Podcast"
    class="w-full h-full">
  </iframe>
</div>

**📑 Slide Version**: Prefer a slide deck? View the presentation below or [download the PDF](https://cdn.jsdelivr.net/gh/skill-wanderer/blog-v2-material@main/leading-ai-agents-is-not-much-different-from-leading-people/The_New_Direct_Reports.pdf).

<div class="rounded-lg overflow-hidden border-2 shadow-xl mb-8" style="width: 100%; height: 600px;">
  <iframe 
    src="https://cdn.jsdelivr.net/gh/skill-wanderer/blog-v2-material@main/leading-ai-agents-is-not-much-different-from-leading-people/The_New_Direct_Reports.pdf" 
    style="width: 100%; height: 100%; border: none;"
    title="The New Direct Reports — Presentation Slides">
  </iframe>
</div>

**🖼️ Infographic**: Get a visual overview of the five leadership lessons that carried straight over from managing people to managing AI agents:

<img src="https://cdn.jsdelivr.net/gh/skill-wanderer/blog-v2-material@main/leading-ai-agents-is-not-much-different-from-leading-people/Leading_AI_with_Management_Skills.png" alt="Leading AI with Management Skills — infographic overview" class="w-full h-auto rounded-lg shadow-xl mb-8" />

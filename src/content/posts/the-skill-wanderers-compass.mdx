...
import calibratingCompass from '../../../public/images/blog/the-skill-wanderers-compass/Calibrating-the-Compass.jpg';
import earlyExperiments from '../../../public/images/blog/the-skill-wanderers-compass/Putting-the-Compass-to-Use-Early-AI-Experiments.jpg';
import moodlePlatform from '../../../public/images/blog/the-skill-wanderers-compass/My-Open-Learning-Project-The-Moodle-Platform.jpg';
...
• **Tackling Dense Docs with [NoteBookLM](https://notebooklm.google.com/)**: One of my first really practical uses was feeding the massive, hundreds-of-pages user guide for my [Orange Pi](https://www.orangepi.org/) into [NoteBookLM](https://notebooklm.google.com/). Being able to ask specific questions and get relevant info pulled out instantly, instead of scrolling endlessly, was a game-changer for getting that hardware set up.
...
While the courses themselves are still just ideas swirling in my head, you can check out the live platform (though it's pretty empty right now!) at: [Skill-Wanderer Dojo](https://dojo.skill-wanderer.com/)

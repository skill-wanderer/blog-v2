...
import dayOneGoalImage from '../../../public/images/blog/wanderers-log-2-home-data-center-day-1-practical-poc-single-node/Day-1-goal-and-three-steps-guild.jpg';
import hardwareSpecsImage from '../../../public/images/blog/wanderers-log-2-home-data-center-day-1-practical-poc-single-node/hardware-specification.jpg';
import techComponentsImage from '../../../public/images/blog/wanderers-log-2-home-data-center-day-1-practical-poc-single-node/technology-components.jpg';
import hardwareToLiveImage from '../../../public/images/blog/wanderers-log-2-home-data-center-day-1-practical-poc-single-node/hardware-to-live-webstite.jpg';
import pocSuccessImage from '../../../public/images/blog/wanderers-log-2-home-data-center-day-1-practical-poc-single-node/POC-success-metric-and-internet-speed-check.jpg';
import nextStepsImage from '../../../public/images/blog/wanderers-log-2-home-data-center-day-1-practical-poc-single-node/next-step.jpg';
import aboutSkillWandererImage from '../../../public/images/blog/wanderers-log-2-home-data-center-day-1-practical-poc-single-node/about skill-wanderer.jpg';
...
<Image src={dayOneGoalImage} alt="Day 1 Goal and Three Steps Guide" class="w-full h-auto rounded-lg shadow-lg mb-8" />
...
**Watch the Video Version or Listen to the Podcast**: If you prefer video content, here's the complete video walkthrough of this Day 1 practical implementation:

<div class="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden border-2 shadow-xl mb-8">
  <iframe 
    src="https://www.youtube-nocookie.com/embed/CxwpADKSaEA?si=_byZ_G3LEsEwmYg-" 
    frameborder="0" 
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
    referrerpolicy="strict-origin-when-cross-origin" 
    allowfullscreen
    title="Wanderer's Log #2 & Home Data Center Day 1: Practical POC Video Guide"
    class="w-full h-full">
  </iframe>
</div>
...
<iframe data-testid="embed-iframe" style="border-radius:12px" src="https://open.spotify.com/embed/episode/4rfQk32MB5OhBk98rpErh4?utm_source=generator" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

<Image src={hardwareSpecsImage} alt="Hardware Specifications Comparison" class="w-full h-auto rounded-lg shadow-lg mb-8" />
...
<Image src={techComponentsImage} alt="Technology Components Overview" class="w-full h-auto rounded-lg shadow-lg mb-8" />
...
<Image src={hardwareToLiveImage} alt="From Hardware to Live Website Process" class="w-full h-auto rounded-lg shadow-lg mb-8" />
...
<Image src={pocSuccessImage} alt="POC Success Metrics and Internet Speed Check" class="w-full h-auto rounded-lg shadow-lg mb-8" />
...
<Image src={nextStepsImage} alt="Next Steps and Future Planning" class="w-full h-auto rounded-lg shadow-lg mb-8" />
...
<Image src={aboutSkillWandererImage} alt="About Skill-Wanderer: Where Education Meets Real-World Impact" class="w-full h-auto rounded-lg shadow-lg mb-8" />

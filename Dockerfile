...
# Define build arguments for Pathfinder / Nova chatbot
ARG PUBLIC_PATHFINDER_API_URL
ARG PUBLIC_PATHFINDER_DOMAINS
ARG PUBLIC_PATHFINDER_SESSION_EXPIRY_MINUTES
ARG PUBLIC_PATHFINDER_SESSION_STORAGE
...
ENV PUBLIC_PATHFINDER_API_URL=$PUBLIC_PATHFINDER_API_URL
ENV PUBLIC_PATHFINDER_DOMAINS=$PUBLIC_PATHFINDER_DOMAINS
ENV PUBLIC_PATHFINDER_SESSION_EXPIRY_MINUTES=$PUBLIC_PATHFINDER_SESSION_EXPIRY_MINUTES
ENV PUBLIC_PATHFINDER_SESSION_STORAGE=$PUBLIC_PATHFINDER_SESSION_STORAGE
